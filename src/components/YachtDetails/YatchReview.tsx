...
const Review: React.FC = () => {
  ...
  const oldSailingPrice = yachtData?.price?.sailing
    ? `₹${Number(yachtData.price.sailing.peakTime || 0).toLocaleString()}`
    : "";

  const oldStillPrice = yachtData?.price?.anchoring
    ? `₹${Number(yachtData.price.anchoring.peakTime || 0).toLocaleString()}`
    : "";
  ...
  const yachtDetails = {
    ...
    summary: {
      ...
      location: yachtData?.pickupat || "Goa",
  ...
  // Helper to prettify package type string
        ...
        <div className={styles.details}>
            ...
            <div className={styles.left}>
              ...
              <div className={styles.price_box}>
                <div className={styles.pricess}>
                  ...
                  <div className={styles.price_value}>{oldSailingPrice}.00</div>
                </div>
                <div className={styles.pricess2}>
                  <div className={styles.price_type}>Still/Anchorage Price</div>
                  <div className={styles.price_value}>{oldStillPrice}.00</div>
                </div>
              </div>
            </div>
          ...
          <div className={styles.detailedPricing}>
            ...
            <div className={styles.price_block}>
              <p>
                <b>Peak Hours Sailing:</b> {peakSailing}.00
              </p>
              <p>
                <b>Peak Hours Anchorage:</b> {peakAnchoring}.00
              </p>
            </div>
            <div className={styles.price_block}>
              <p>
                <b>Non-Peak Hours Sailing:</b> {nonPeakSailing}.00
              </p>
              <p>
                <b>Non-Peak Hours Anchorage:</b> {nonPeakAnchoring}.00
              </p>
            </div>
          </div>
          ...
          <div className={styles.guidelines}>
            ...
            <ul>
              ...
              <li>
                <b>Respect Policy:</b> Weather changes during the trip may
